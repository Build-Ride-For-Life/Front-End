...
`0.3.8` - 2017-05-03
* reconciled recently introduced difference between `index.es.js` and `axiosWithAuth.js`
...
When you run `npm test`, linting will be performed and `axiosWithAuth.js` will be built from `index.es.js`. Any linting errors will fail the tests... this includes code formatting.
